...
x_steps = 500
y_steps = 5
min_x,max_x,min_y,max_y = autocad_analyzing.make_a_sec_grid(acad,pipes_table,x_steps,y_steps)
autocad_analyzing.draw_pipe_sec(acad,pipes_table,min_y,max_y)
