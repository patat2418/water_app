...
def set_channel_data(channel: pd.Series, scale = 100 , margin = 80, padding = 4, text_height = 2.5):
...
def draw_channel_geometry(channel: pd.Series, channel_data: dict, y_padding = 100, x_padding = 100, text_height = 2.5):
...
def draw_channel_water(channel: pd.Series, channel_data: dict, water_points: APoint, text_height = 2.5):
    ...
    text = acad.model.Addtext(channel_data['des_flow'],water_text_point,text_height)
    ...
    if channel_data['max_water_depth']:
        ...
        text = acad.model.Addtext(channel_data['max_flow'],max_water_text_point,text_height)

        if (channel_data['max_water_depth'] < channel_data['water_depth']):
            max_water_text_point.y -= 10
            max_water_text_point.x -= 50
            text1 = acad.model.Addtext(channel_data['bad_geometry_text'],max_water_text_point,text_height*2)
            text1.color = 1

def add_channel_section(channel: pd.Series, margin = 100, x_padding = 100, text_height = 2.5):
